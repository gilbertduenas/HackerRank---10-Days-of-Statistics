...
# The form of the definition involves a "product moment", that is, 
# the mean (the first moment about the origin) of the product of the mean-adjusted random variables; hence the modifier product-moment in the name.
